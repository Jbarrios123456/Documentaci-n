<h1 align="center">Documentacion Externa Proyecto 1 - Junior Barrios</h1>
...
Para ejecutar mi proyecto en las diferentes aplicaciones lo unico que necesita son los codigos para cada aplicacion (Archivos subidos en el repositorio de mi proryecto), cada archivo tiene su respectivo nombre proyecto 1 y una pequeña guia de que archivo es para cada aplicación.
- Para demostrar cada punto pondre 1 opcion en cada lenguaje de programacion, debido a que las 3 aplicaciones tienen el mismo funcionamiento

  ## Funcion Factorial de un numero (Pseint)
  En esta funcion se le pedira al usuario un numero (debe ser entero y positivo, de otra manera el programa le pedira que ingrese otro numero), y el programa calculara su factorial
  para esta demostracion utilizaremos el numero 7: 7! = 5040
  <img width="431" height="256" alt="image" src="https://github.com/user-attachments/assets/f4bd7f8b-6c11-4c61-9396-0c047be4a742" />

 ## Funcion Sistema Subsidio de Familias (C++) 
 En esta funcion, es una funcion compleja, en primer lugar se le preguntara cuantos hijos posee la familia, si es menor o igual a 3, se le daran 300 de donacion, si es un numero de hijos entre 4 y 5, se le donaran 350, y si el numero de hijos es mayor a 5, se le donaran 400 quetzales, incluyendo un sistema de bonificación, en que si alguno de los hijos esta entre la edad de 7 a 18 años, se le dara una bonificacion del 6% de la donacion que le toca.
 - En este ejemplo tendremos una familia de 4 hijos (se le donaran 350 quetzales), pero contiene 2 hijos entre la edad de 7 a 18 años, eso incluye la bonificacion del 6% de lo que ganara (350*6)/100 = 21, eso por sus 2 hijos 21+21=42, 350+42= 392 quetzales que la familia recibira sumando las donaciones
<img width="703" height="496" alt="image" src="https://github.com/user-attachments/assets/7e333e0b-ad16-448b-8f28-83f34fef587e" />

 ## Funcion el programa finaliza hasta que el usuario ingresa el numero 3 (Phyton) 
 Esta funcion como su nombre lo indica, el programa puede hacer n cantidad de calculos, y se terminara solo si el usuario ingresa el numero "3".
 <img width="918" height="546" alt="image" src="https://github.com/user-attachments/assets/9ed05329-bc65-4c8c-b3f4-e4ffe644b623" />
